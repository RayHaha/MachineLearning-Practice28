...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	double error_in_pertree[30000];
	double error_in[30000];
	//int output[30000][100];
	for(int i=0; i<30000; i++){
		error_in_pertree[i] = 0;
		error_in[i] = 0;
	}
	...
	for(int t=0; t<30000; t++){
		...
		error_in[t] = error_per_t/(double)100;
		fein<<error_in[t]<<endl;
	}
	
	cout<<error_in[29999]<<endl;
